...
/**
 * This is the flow which handles issuance of new payments on the ledger.
...
@InitiatingFlow
@StartableByRPC
class IOUIssueFlow(val state: ResponsibilityState): FlowLogic<SignedTransaction>() {
    @Suspendable
    override fun call(): SignedTransaction {
        ...
        val issueCommand = Command(PaymentContract.Commands.Issue(), state.participants.map { it.owningKey })
